...
DATA_DIR = f"{BASE_PATH}/datasets/desisto_pHGG_scRNA/scRNA"
OUTPUT_DIR = f"{BASE_PATH}/figures/desistofeature_figures"
...
def load_all_samples(data_dir):
    ...
    for sample_name in SAMPLES_TO_ANALYZE:
        h5ad_file = data_path / sample_name / f"{sample_name}_processed_rna.h5ad"
        try:
            print(f"\n  Loading {sample_name}...")
